  ...
  return (
    <>
      ...
      <div className="flex justify-around items-center">
        ...
        <div className="flex flex-row items-center">
          ...
          <div className="flex flex-row items-center">
            ...
            <p className="font-inter text-medium font-bold tracking-normal mr-2 leading-none text-center">
              WhishList
            </p>
          </div>
          <div
      ...
      <div className="bg-black p-4 flex w-full justify-around">
        <div className="text-white font-inter text-medium font-bold tracking-normal mr-2 leading-none text-center">
          50% OFF
        </div>
        <div className="text-white font-inter text-medium font-bold tracking-normal mr-2 leading-none text-center">
          Free Shipping
